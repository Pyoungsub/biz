...
<header class="sticky top-0 z-40 bg-white/70 dark:bg-slate-950/60 glass border-b border-slate-200/60 dark:border-slate-800">
    ...
    <div class="flex items-center justify-between h-16">
        ...
        @else
            ...
            <a href="{{ route('login') }}" 
            class="hidden sm:inline-flex items-center gap-2 px-4 py-2 rounded-xl border border-slate-900 text-slate-900 dark:border-white dark:text-white hover:bg-slate-900 hover:text-white dark:hover:bg-white dark:hover:text-slate-900 shadow-soft text-sm font-semibold transition">
                Log in
            </a>
