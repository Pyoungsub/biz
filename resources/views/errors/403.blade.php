...
<body class="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-4">
    <div class="text-center">
        <h1 class="text-8xl font-extrabold text-gray-800 dark:text-gray-100 mb-4 animate-pulse">403</h1>
        <p class="text-2xl text-gray-600 dark:text-gray-400 mb-6">Sorry, you don't have permission to access this page.</p>
